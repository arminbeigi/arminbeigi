...
DEFAULT_SETTINGS = {
    ...
    "phone_history": [],
    # نام کسب‌وکار کاربر — در متن پیام و در لینک پیش‌فاکتور استفاده می‌شود
    # تا گیرنده فروشنده را بشناسد و به لینک اعتماد کند.
    "business": {
        "name": "",        # نام نمایشی (مثلاً «فروشگاه شوفاژ») — در متن پیامک
        "url_slug": "",     # نام کوتاه لاتین برای لینک (مثلاً shofazh)؛ خالی = خودکار
    },
    # متن پیام (کپشن فایل) که برای مشتری ارسال می‌شود. متغیرها: {business} {name} {invoice} {link}
    "welcome_message": "{name} عزیز، پیش‌فاکتور شما از {business} آماده است.",
    "wordpress": {
        "enabled": False,
        "url": "",
        "username": "",
